...
const APP_TEXT: Record<AppLocale, {
  ...
  "zh-CN": {
    close: "关闭", closeProject: "关闭项目", archiveSession: "归档会话", newSession: "新对话", importProject: "导入项目", pinnedProjects: "置顶项目", projects: "项目", openWorkspace: "打开工作区", loadMore: "加载更多", pinProject: "置顶项目", unpinProject: "取消置顶", settings: "设置", noProjectsHint: "还没有项目，先导入一个本地工作区。", agentRequired: "导入项目后即可使用会话。", collapseSidebar: "收起左侧栏", expandSidebar: "展开左侧栏", collapseRightSidebar: "收起右侧栏", expandRightSidebar: "展开右侧栏", changes: "审查", worktree: "工作树", terminal: "终端", skills: "技能", plugins: "插件", automation: "自动化", search: "搜索", searchPlaceholder: "搜索消息…", searchScopeCurrentSession: "当前会话", searchScopeCurrentRepo: "当前仓库", searchScopeAll: "所有仓库", searchNoResults: "没有找到相关消息", searchLoading: "正在搜索…", searchEmptyHint: "输入关键词以搜索消息，支持当前会话或跨会话检索", mcp: "MCP", closeFileView: "关闭文件视图", removeWorktree: "移除 worktree", removeWorktreeTitle: "移除 worktree？", removeWorktreeDesc: "这会删除 worktree 目录并清理 Git worktree 记录，目录内文件会被删除。", removing: "移除中...", confirmRemove: "确认移除", cancel: "取消",
