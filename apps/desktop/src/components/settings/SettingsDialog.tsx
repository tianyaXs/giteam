...
import { AboutIcon, BellIcon, ImageIcon, LinkIcon, ModelIcon, PackageIcon, PluginsIcon, RefreshIcon, SettingsIcon, SkillsIcon, SoundIcon, SyncIcon } from "../icons";
            ...
            <CardContent className="flex flex-col gap-0 p-0">
              <div className="flex items-center justify-between gap-4 border-b border-border/70 px-4 py-3.5">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-[14px] leading-6 text-muted-foreground">统一检查和安装必要插件。</p>
                </div>
                <Button
                  variant="secondary"
                  size="sm"
