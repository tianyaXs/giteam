...
export function OpencodeInstalledSkillGroups(props: InstalledSkillGroupsProps) {
  ...
  return groups.map((group) => {
    ...
    return (
      <Collapsible key={group.name} className="gt-installed-skill-group">
        <div className="gt-installed-skill-group-head">
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
              className="gt-installed-skill-group-trigger"
              title={group.name}
            >
              <div className="gt-installed-skill-group-main">
                <div>
              ...
              <ChevronDown className="gt-installed-skill-group-chevron" aria-hidden="true" />
            </Button>
          </CollapsibleTrigger>
          <Button
            variant="ghost"
        ...
        <CollapsibleContent className="gt-installed-skill-group-items">
  ...
  return rows.map((result, index) => {
    ...
    return (
      <div
        ...
        className={cn("gt-skill-card-item", selectedSpec === result.spec && "active")}
      >
        <Button
          variant="ghost"
          className="gt-skill-card-main"
            ...
            <article key={group.name} className="settings-skill-card">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="settings-skill-menu-trigger" aria-label={`${group.name} actions`} title="Actions">
      ...
      <div className="gt-skill-market-layout">
        <main className="gt-skill-leaderboard-card" ref={marketListRef} onScroll={onScrollMarket}>
          ...
          <div className="gt-skill-filterbar">
            <ToggleGroup
              ...
              className="gt-skill-mode-toggle"
              aria-label="搜索模式"
            >
              {([
                ["keyword", "关键词"],
          ...
          <div className="gt-skill-market-tabs">
            <Button
              variant="ghost"
              size="sm"
              className={installedView ? "active" : ""}
            ...
            {([
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className={!installedView && catalogView === view && searchResults.length === 0 ? "active" : ""}
                onClick={() => {
                  setMarketTab(view);
          ...
          {installedView ? (
            <div className="gt-installed-skill-grid gt-skill-market-installed-grid">
        ...
        <aside className="gt-skill-inspector-card">
            ...
            <>
              ...
              <div className="gt-skill-inspector-actions gt-skill-install-wrap">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="start" className="gt-skill-install-menu">
                    <DropdownMenuGroup>
          ...
          <div className="gt-installed-skills-mini">
            <div className="gt-installed-skills-head"><div><strong>已安装</strong><span>{groups.length} 组 / {skills.length} skills</span></div><Button variant="ghost" size="sm" onClick={() => void onRefreshSkills()} disabled={skillsLoading}>刷新</Button></div>
            {groups.slice(0, 6).map((group) => (
              <Button variant="ghost" key={group.name} className="gt-installed-skill-row is-reference" onClick={() => onReferenceSkill(group.items[0])}>
