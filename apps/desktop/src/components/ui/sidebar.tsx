...
>(function SidebarInput({ className, ...props }, ref) {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "h-8 w-full bg-background shadow-none focus-visible:border-sidebar-ring/60 focus-visible:ring-2 focus-visible:ring-sidebar-ring/40",
        className
      )}
      {...props}
    />
...
>(function SidebarGroupAction({ className, asChild = false, ...props }, ref) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-3 top-3.5 flex aspect-square w-5 appearance-none items-center justify-center rounded-md border-0 bg-transparent p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
>(function SidebarGroupContent({ className, ...props }, ref) {
  return <div ref={ref} data-sidebar="group-content" className={cn("min-w-0 w-full overflow-x-hidden text-sm", className)} {...props} />;
});
...
>(function SidebarMenu({ className, ...props }, ref) {
  return <ul ref={ref} data-sidebar="menu" className={cn("m-0 flex w-full min-w-0 list-none flex-col gap-1 p-0", className)} {...props} />;
});
...
>(function SidebarMenuItem({ className, ...props }, ref) {
  return <li ref={ref} data-sidebar="menu-item" className={cn("group/menu-item relative min-w-0 list-none", className)} {...props} />;
});

const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full appearance-none items-center gap-2 overflow-hidden rounded-md border-0 bg-transparent p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
...
>(function SidebarMenuAction({ className, asChild = false, showOnHover = false, ...props }, ref) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 appearance-none items-center justify-center rounded-md border-0 bg-transparent p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0",
...
>(function SidebarMenuSub({ className, ...props }, ref) {
  return (
    <ul
      ...
      className={cn(
        "mx-3.5 flex min-w-0 max-w-full translate-x-px list-none flex-col gap-1 overflow-x-hidden border-l border-sidebar-border px-2.5 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
...
>(function SidebarMenuSubItem({ className, ...props }, ref) {
  return <li ref={ref} className={cn("min-w-0 list-none", className)} {...props} />;
});
...
>(function SidebarMenuSubButton(
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-7 min-w-0 max-w-full -translate-x-px appearance-none items-center gap-2 overflow-hidden rounded-md border-0 bg-transparent px-2 text-sidebar-foreground outline-none ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
