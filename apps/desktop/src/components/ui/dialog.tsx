...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("gt-dialog-title", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn("gt-dialog-description", className)} {...props} />
));
